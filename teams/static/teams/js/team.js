$(document).ready(function() {
	...
	$('#inv-create').submit(function(event) {
		...
		$.post(
			...
			var list_entry = $(`<li>${data.username} has been invited<span style="display: none; float: right;">&nbsp;</span></li>`);
	...
	$('#req-create').submit(function(event) {
		...
		$.post(
			...
			var list_entry = $(`<li>You have requested to join ${data.team}<span style="display: none; float: right;"></span></li>`);
